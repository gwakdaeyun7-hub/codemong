...
| `lessonId` | `lesson-N` 형식. CodeMong 강의 체계 따름 (Python 기초는 lesson-1 ~ lesson-15). | `lesson-1` |
| `topic` | 강의 제목 (참고용, slug 안 만듦) | "Python이란?" |
...
**입력**: `01-script.md` 경로 + Remotion 프로젝트 위치 + `orientation`.

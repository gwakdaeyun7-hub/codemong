/**
 * Scene 1 — 도입: 오늘 다룰 것 + 6강 회상 (12s)
 *
 * 시즌 정형 통일 (lesson-3·5·6 Scene01 baseline) — inset:0 center,
 * h1 110/800/ink, underline width 180, 36px gap, 부제 36/500/inkMuted.
 * 회상카드 안 `LoopIcon` 은 narration "반복문" 직결로 정형 ✓ 카드 *내부*
 * 에 작게만 (펄스 없음, 정형 metric 그대로). 6강 v2 정책.
 *
 * 1·2·3·4·5·6강과 동일한 도입 패턴.
 */
    ...
    <PageBackground>
      ...
      <div style={{ position: "absolute", top: 96, left: 96 }}>
        <FadeIn delaySec={0.2} translateY={6}>
          <CourseLabel>파이썬 기초 · 7강</CourseLabel>
        </FadeIn>
      </div>
      ...
      {/* 우측 하단 회상 카드 (6강 회상 — narration 직결) */}

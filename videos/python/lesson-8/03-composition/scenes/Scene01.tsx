/**
 * Scene 1 — 도입: 오늘 다룰 것 + 7강 리스트 회상 (13s)
 *
 * 시즌 정형 통일 (lesson-3/6 Scene01 baseline) — inset:0 center,
 * h1 110/800/ink, underline width 180, 36px gap, 부제 36/500/inkMuted.
 * 회상카드: ✓ 마커 + 7강 리스트 한 줄 코드 + 인덱스 결과.
 * Scene01 정형 5요소:
 ...
 * 7강 영상 미제작이므로 회상 카드는 _리스트 한 줄 개념만_ (메서드 없음).
 */
    ...
    <PageBackground>
      ...
      <div style={{ position: "absolute", top: 96, left: 96 }}>
        <FadeIn delaySec={0.2} translateY={6}>
          <CourseLabel>파이썬 기초 · 8강</CourseLabel>
        </FadeIn>
      </div>
      ...
      {/* 우측 하단 회상 카드 (7강 리스트 회상 — narration 직결) */}

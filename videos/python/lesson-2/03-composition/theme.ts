 ...
 *
 * Identical to lesson-1/theme.ts — kept as a per-lesson copy (not imported)
 * to keep `videos/<courseId>/<lessonId>/03-composition/` as a self-contained
 * unit per the workspace-layout contract. If the design system ever drifts
 * between lessons, each lesson can evolve independently.
 *

...
export const colors = {
  ...
  syntaxKeyword: "#c084fc", // purple-400 — True/False/and/or/not
  syntaxString: "#fbbf24", // amber-400 — "이름이 무엇인가요?"
  syntaxNumber: "#34d399", // emerald-400 — 3, 5, 7
  syntaxName: "#e4e4e7", // zinc-200 — name, a, b, korean, total (변수)
  syntaxFunc: "#60a5fa", // blue-400 — input, int, print

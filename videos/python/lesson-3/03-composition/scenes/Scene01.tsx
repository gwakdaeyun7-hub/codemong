/**
 * Scene 1 — 도입: 오늘 배우는 것 (14s)
 *
 * - 좌상단 코스 라벨: "파이썬 기초 · 3강"
 * - 중앙 큰 제목: "변수와 자료형"
 * - violet underline
 * - 부제목: "값에 이름을 붙이고 화면에 보여주기"
 * - 우측 하단 회상 카드 (2강 mock): "2강 — 코딩의 표현 방법 ✓" (opacity 0.6)
 *
 * 1강·2강과 동일한 도입 패턴 — 시즌 통일성.
 */
    ...
    <PageBackground>
      ...
      <div style={{ position: "absolute", top: 96, left: 96 }}>
        <FadeIn delaySec={0.2} translateY={6}>
          <CourseLabel>파이썬 기초 · 3강</CourseLabel>
        </FadeIn>
      </div>
